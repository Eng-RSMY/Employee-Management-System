...
class employerController extends Controller
{
    ...
    {      
      ...
      $data=array('emp_id'=>$employer_id,'emp_name'=>$employer_name,'emp_address'=>$address,'emp_phn_number'=> $phone_number,'emp_pic'=>$image_path,'ref_name'=>$ref_name,'ref_phn_no'=>$ref_phone_number);
